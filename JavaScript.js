...
const type = "grass";
const answer1 = pokes.filter(poke => poke.types.includes(type)).map(poke => poke.name); // TODO
...
const answer2Or = pokes.filter(poke => poke.types.some(t => types.includes(t))).map(poke => poke.name); // TODO
const answer2And = pokes.filter(poke => types.every(t => poke.types.includes(t))).map(poke => poke.name); // TODO
